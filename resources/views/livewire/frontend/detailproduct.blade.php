        ...
        <section class="breadcrumbs">
            <div class="container">
                <ol>
                    ...
                    <li><a href="{{ route('product-front') }}">Produk</a></li>
                    <li>Detail Produk</li>
                </ol>
                <h2>Detail Produk</h2>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 entries">
                        <article class="entry entry-single">
                            <div class="entry-img">
                                <img src="{{ asset('storage/' . $news->image) }}" alt="" class="img-fluid w-100">
                            </div>
                            <h2 class="entry-title">
                                <a
                                    href="{{ route('detail-product-front', Crypt::encrypt($news->id)) }}">{{ $news->produk }}</a>
                            </h2>
                            ...
                            <div class="entry-meta">
                                <ul>
                                    ...
                                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                            href="{{ route('detail-product-front', Crypt::encrypt($news->id)) }}"><time
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" min="0"
                                                    placeholder="Jumlah produk yang ingin dibeli.." name="qty"
                                                    id="" class="form-control">
                                                <input type="hidden"
                                                    placeholder="Jumlah produk yang ingin dibeli.." name="price" value="{{ $news->harga }}"
                                                    id="" class="form-control">
                                                <input type="hidden"
                                                    placeholder="Jumlah produk yang ingin dibeli.." name="product_id" value="{{ $news->id }}"
                                                    id="" class="form-control">
                                                </td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="sidebar-item recent-posts">
                                @foreach ($recent as $x)
                                    <div class="post-item clearfix">
                                        ...
                                        <h4><a
                                                href="{{ route('detail-product-front', Crypt::encrypt($x->id)) }}">{{ $x->produk }}</a>
                                        </h4>
